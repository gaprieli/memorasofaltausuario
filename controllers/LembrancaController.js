    ...
    constructor(){
        this.openAdd = async(req, res)=>{
            try {
                ...
                res.render("lembranca/add", { usuarios: usuarios, lugares: lugares, empresas: empresas });
            } catch (error) {
        ...
        this.list = async(req, res)=>{
            ...
            res.render('lembranca/lst', {lembrancas:resultado}) // Consider adding .sort({ data: -1 }) or similar
        }
        this.find = async(req, res)=>{
            ...
            res.render('lembranca/lst', {lembrancas:resultado})
        }
        this.openEdt = async(req, res)=>{
            ...
            res.render("lembranca/edt", { lembranca, usuarios, lugares, empresas });
        }
